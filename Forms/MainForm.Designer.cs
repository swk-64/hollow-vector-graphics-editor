...
namespace hollow_vector_graphics_editor
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            btn_layer_up = new ToolStripButton();
            btn_layer_down = new ToolStripButton();
            ...
            tableLayoutPanel1.Size = new Size(1486, 960);
            ...
            shape_params.ImageScalingSize = new Size(32, 32);
            shape_params.Items.AddRange(new ToolStripItem[] { btn_change_stroke_color, btn_change_fill_color, btn_layer_up, btn_layer_down });
            shape_params.LayoutStyle = ToolStripLayoutStyle.VerticalStackWithOverflow;
            shape_params.Location = new Point(1319, 0);
            shape_params.Name = "shape_params";
            shape_params.Padding = new Padding(0, 0, 4, 0);
            shape_params.Size = new Size(167, 960);
            ...
            btn_change_stroke_color.Size = new Size(162, 36);
            ...
            btn_change_fill_color.Size = new Size(162, 36);
            btn_change_fill_color.Text = "Change Fill Color";
            // 
            // canvas
            // 
            canvas.Dock = DockStyle.Fill;
            canvas.Location = new Point(62, 6);
            canvas.Margin = new Padding(6, 6, 6, 6);
            canvas.Name = "canvas";
            canvas.Size = new Size(1251, 948);
            canvas.TabIndex = 0;
            ...
            tools.Name = "tools";
            tools.Padding = new Padding(0, 0, 4, 0);
            tools.Size = new Size(56, 960);
            tools.TabIndex = 1;
            tools.Text = "Tools";
            // 
            // btn_selection_tool
            ...
            btn_selection_tool.Size = new Size(51, 36);
            ...
            btn_drw_line.Size = new Size(51, 36);
            ...
            btn_drw_circle.Size = new Size(51, 36);
            ...
            btn_drw_rect.Size = new Size(51, 36);
            btn_drw_rect.Text = "Rectangle Tool";
            // 
            // btn_layer_up
            // 
            btn_layer_up.DisplayStyle = ToolStripItemDisplayStyle.Image;
            btn_layer_up.Image = (Image)resources.GetObject("btn_layer_up.Image");
            btn_layer_up.ImageTransparentColor = Color.Magenta;
            btn_layer_up.Name = "btn_layer_up";
            btn_layer_up.Size = new Size(162, 36);
            btn_layer_up.Text = "layer up";
            // 
            // btn_layer_down
            // 
            btn_layer_down.DisplayStyle = ToolStripItemDisplayStyle.Image;
            btn_layer_down.Image = (Image)resources.GetObject("btn_layer_down.Image");
            btn_layer_down.ImageTransparentColor = Color.Magenta;
            btn_layer_down.Name = "btn_layer_down";
            btn_layer_down.Size = new Size(162, 36);
            btn_layer_down.Text = "layer down";
            // 
            // MainForm
            // 
        ...
        private ToolStripButton btn_layer_up;
        private ToolStripButton btn_layer_down;
    }
}
